...
public class AdditionQuiz {
	...
	/*
	 * Creates the arrays that hold the numbers for the questions and fills them with random numbers
	 */
	...
	/*
	 * Shows all the questions, with their correct answers, and computes a grade for the quiz.
	 * For each question, the user is told whether they got it right.
	 */
